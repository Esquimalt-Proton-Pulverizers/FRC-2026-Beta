...
public final class HangConstants { // XXX: Set correct values for your robot
   ...
   */
  public static final double kPotRetractedVoltage = 5.0;
  public static final double kPotExtendedVoltage = kPotRetractedVoltage * 0.33;
  ...
  public static final double kMaxVoltage = 2.0;
